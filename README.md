...
🚀 Full-Stack Developer | Next.js • NestJS • TypeScript • Docker

I’m a passionate software engineer from **Bangladesh**, working remotely and building scalable, high-performance web applications.

I love turning ideas into real products using clean architecture, strong backend systems, and beautiful frontend experiences.
...
- ⚡ Strong in TypeScript & modern JavaScript
- 🧠 Learning: Docker, DevOps, Nginx, Cryptography, VR (Meta Quest)
- 🔧 Building real-world production apps
- 🌍 Remote engineer for US-based companies
...
![React Hook Form](https://img.shields.io/badge/ReactHookForm-black?style=for-the-badge)
...
- 📚 Dynamic Admission Form System
- 🧾 Sales & Purchase Management Apps
- 🔐 Secure Auth Systems (JWT + NestJS)
- 📦 Full-Stack SaaS Platforms
- 🌌 3D Solar System with Three.js
- 🧠 AI / Image Classification Experiments

👉 More projects: https://sajib-eta.vercel.app/
